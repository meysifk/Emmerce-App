...
class Home extends React.Component{
    ...
    searchBtnHandler = () => {
        ...
        this.setState({filteredProductList: filteredProductList, maxPage: Math.ceil(filteredProductList.length / this.state.itemPerPage), page: 1})
    }
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <select onChange={this.inputHandler} name="searchCategory" className="form-control">
                                    <option value={"Shirt" || "Pants" || "Accessories"}>All Items</option>
