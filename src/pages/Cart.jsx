...
class Cart extends React.Component{
    ...
    payBtnHandler = () => {
        ...
        if(this.state.payment > this.renderTotalPrice()){
            alert(`Success anda mendapatkan kembalian ${this.state.payment - this.renderTotalPrice()}`)
        ...
        Axios.post(`${API_URL}/transactions`, {
            ...
            transactionItems: this.props.cartGlobal.cartList, //Array of object -> Product
        })
        .then((result) => {
            alert('berhasil')
                    ...
                    <div className="col-3">
                        <div className="card text-left">
                            ...
                            <div className="card-body">
                                <div className="d-flex my-2 d-row justify-content-between align-items-center">
                                ...
                                <div className="d-flex my-2 d-roxw justify-content-between align-items-center">
